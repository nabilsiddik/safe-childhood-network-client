...
const Authentication = () => {
  ...
  return (
    <div className='bg-secondary min-h-screen relative'>
      <div className="container mx-auto px-5 relative min-h-screen flex flex-col justify-center items-center">
        <Image src={'/images/logo/scn-home-logo.jpg'} alt='safe childhood network logo' width={300} height={300} />
