      ...
      <div className='bg-[#d2edf7] backdrop-blur-lg flex-1 p-5 overflow-y-auto max-h-screen no-scrollbar pt-30 pb-20'>
        ...
        <div className='mb-10'>
          <div className='bg-[#00FF6C78] text-black p-7 rounded-lg rounded-bl-none max-w-10/12 lg:max-w-6/12 xl:max-w-4/12 mb-2'>
            <p>Hi! Thanks for reaching out. What can I get for you</p>
          </div>
          <div className='bg-[#00FF6C78] text-black p-7 rounded-lg rounded-bl-none max-w-10/12 lg:max-w-6/12 xl:max-w-4/12'>
            <p>Hi! Thanks for reaching out. What can I get for you</p>
          </div>
        ...
        <div className='mb-10 flex flex-col items-end'>
          ...
          <div className='bg-[#718FF9] text-white p-7 rounded-lg rounded-br-none max-w-10/12 lg:max-w-6/12 xl:max-w-4/12'>
            <p>Hi! Thanks for reaching out. What can I get for you sdfsdfsdf</p>
          </div>
          <div className='mt-1 text-[#515151]'>02:58 PM</div>
        </div>
